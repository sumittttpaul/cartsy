...
class CartsyCutomPageWalker extends Walker
{
    ...
    public function start_el(&$output, $page, $depth = 0, $args = array(), $current_page = 0)
    {
        ...
        if ('' === $page->post_title) {
            ...
            $page->post_title = sprintf(esc_html__('#%d (no title)', 'cartsy'), $page->ID);
        }
        ...
        $output .= '</a>';
        if ($has_children > 0) {
            $output .= '<span class="ion ion-ios-arrow-forward menu-drop-down-selector" title="open"></span>';
        }
