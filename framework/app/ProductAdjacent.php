...
/**
 * Cartsy WooCommerce Adjacent Products Class
 *
 * @package  Cartsy
 * @since    2.4.3
 */
...
if (!class_exists('ProductAdjacent')) :

    /**
     * The Cartsy WooCommerce Adjacent Products Class
     */
    class ProductAdjacent
    {
        ...
        public function getProduct()
        {
            ...
            while ($adjacent = $this->getAdjacent()) {
        ...
        private function getAdjacent()
        {
            ...
            add_filter('get_' . $direction . '_post_where', array($this, 'filterPostWhere'));
            $adjacent = get_adjacent_post($this->in_same_term, $this->excluded_terms, $this->previous, $this->taxonomy);
            remove_filter('get_' . $direction . '_post_where', array($this, 'filterPostWhere'));
            return $adjacent;
        }
         ...
         * @return WP_POST|false Post object if successful. False if no valid post is found.
         */
        public function filterPostWhere($where)
        {
            global $post;
        ...
        private function queryWC()
        {
            ...
            $products = wc_get_products(apply_filters('cartsy_woocommerce_adjacent_query_args', $args));
