...
?>
<div <?php wc_product_class('cartsy-grid-radon', $product); ?>>
    ...
    <div class="cartsy-radon-product-card cartsy-product-<?php echo esc_attr($product->get_id()); ?> type-product product">
        <?php if ($isOnSale) { ?>
            <span class="product-badge">
                <?php echo esc_html__('Sale', 'cartsy'); ?>
            </span>
        <?php } ?>
        <div class="cartsy-radon-product-card-thumb">
        ...
        <div class="cartsy-radon-product-card-description">
            <div class="cartsy-radon-product-card-info">
                <div class="cartsy-radon-product-card-price">
                    <?php if (!$isInStock) { ?>
                ...
                <a href="<?php echo esc_url($link); ?>" class="cartsy-radon-product-card-title">
            ...
            <?php if ($isInStock) { ?>
                ...
                <?php if ($productType === 'simple') { ?>
                    ...
                    <div class="cartsy-radon-product-card-cart-button">
                        <!-- Add to cart button -->
