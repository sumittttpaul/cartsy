...
<div <?php wc_product_class('cartsy-grid-argon', $product); ?>>
    ...
    <div class="cartsy-argon-product-card">
        <div class="cartsy-argon-product-card-thumb">
            <?php if ($isOnSale) { ?>
        ...
        <div class="cartsy-argon-product-card-description">
            <a href="<?php echo esc_url($link); ?>" class="cartsy-argon-product-card-title">
                <?php woocommerce_template_loop_product_title(); ?>
            </a>
            <div class="cartsy-argon-product-card-price">
                <span class="price">
        ...
        <?php if ($isInStock) { ?>
            <?php if ($productType === 'simple') { ?>
                ...
                <!-- Quantity button -->
                <div class="cartsy-counter size-medium filled cartsy-qty-button cartsy-qty-button-<?php echo esc_attr($product->get_id()); ?>" style="<?php echo esc_attr($display); ?>">
                ...
                <!-- Add-to-cart button -->
                <div class="cartsy-counter hide-it size-medium filled cartsy-qty-button cartsy-add-to-cart-<?php echo esc_attr($product->get_id()); ?>" style="<?php echo esc_attr($cartButton); ?>">
                    <a href="#" class="product_type_simple add_to_cart_button cartsy_ajax_add_to_cart cartsy-update-qty cartsy-add-to-cart-<?php echo esc_attr($product->get_id()); ?>" data-product_id="<?php echo esc_attr($product->get_id()); ?>">
                        <span class="cartsy-counter-update increment">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
            ...
            <?php } else { ?>
                <div class="cartsy-counter hide-it size-medium filled">
                    <a href="<?php echo esc_url($link); ?>">
                        <span class="cartsy-counter-update increment">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                <path data-name="Path 9" d="M143.407,137.783h-1.25v4.375h-4.375v1.25h4.375v4.375h1.25v-4.375h4.375v-1.25h-4.375Z" transform="translate(-137.782 -137.783)" fill="currentColor"></path>
