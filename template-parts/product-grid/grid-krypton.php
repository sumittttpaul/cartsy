...
?>
<div <?php wc_product_class('cartsy-grid-krypton', $product); ?>>
    ...
    <div class="cartsy-krypton-product-card cartsy-product-<?php echo esc_attr($product->get_id()); ?> type-product product">
        <div class="cartsy-krypton-product-card-description">
            <div class="cartsy-krypton-product-card-price">
                <?php if (!$isInStock) { ?>
            ...
            <a href="<?php echo esc_url($link); ?>" class="cartsy-krypton-product-card-title">
                <?php woocommerce_template_loop_product_title(); ?>
            </a>
        </div>

        <div class="cartsy-krypton-product-card-thumb">
            <?php if ($isOnSale) { ?>
            ...
            <?php if ($isInStock) { ?>
                ...
                <?php if ($productType === 'simple') { ?>
                    ...
                    <div class="cartsy-counter cart-add-btn size-medium filled">
                        <!-- Add to cart button -->
