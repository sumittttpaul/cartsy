...
?>
<div <?php wc_product_class('cartsy-grid-fluorine', $product); ?>>
    ...
    <div class="cartsy-fluorine-product-card cartsy-product-<?php echo esc_attr($product->get_id()); ?> type-product product">
        <div class="cartsy-fluorine-product-card-description">
            <div class="cartsy-fluorine-product-card-price">
                <?php if (!$isInStock) { ?>
            ...
            <a href="<?php echo esc_url($link); ?>" class="cartsy-fluorine-product-card-title">
                <?php woocommerce_template_loop_product_title(); ?>
            </a>
        </div>

        <div class="cartsy-fluorine-product-card-thumb">
            <?php if ($isOnSale) { ?>
