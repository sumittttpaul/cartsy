...
<div <?php wc_product_class('cartsy-grid-bromine', $product); ?>>
    ...
    <div class="cartsy-bromine-product-card">
        <div class="cartsy-bromine-product-card-thumb">
            <?php if ($isOnSale) { ?>
            ...
            <?php if (class_exists('CartsyHelper')) { ?>
                <?php if ($isInStock) { ?>
                    <?php if ($productType === 'simple') { ?>
                        <div class="cartsy-bromine-product-card-cart">
                            <!-- Add to cart button -->
                            <a href="#" class="cartsy_btn_display product_type_simple add_to_cart_button cartsy_ajax_add_to_cart cartsy-update-qty cartsy-add-to-cart-<?php echo esc_attr($product->get_id()); ?>" data-product_id="<?php echo esc_attr($product->get_id()); ?>" style="<?php echo esc_attr($cartButton); ?>">
                                <span class="cartsy-bromine-product-card-cart-button">
                                    <span class="label"><?php echo esc_html__('ADD TO CART', 'cartsy'); ?></span>
                                </span>
                            </a>
                            <!-- End -->
                            <!-- Quantity button -->
                            <div class="cartsy-counter filled full-width size-medium cartsy-qty-button cartsy-qty-button-<?php echo esc_attr($product->get_id()); ?> <?php echo esc_attr($qty_class); ?>" style="<?php echo esc_attr($display); ?> margin-bottom: 10px;">
                    ...
                    <?php } else { ?>
                        <div class="cartsy-bromine-product-card-cart">
                            <a href="<?php echo esc_url($link); ?>" class="add_to_cart_button">
                                <span class="cartsy-bromine-product-card-cart-button">
        ...
        <div class="cartsy-bromine-product-card-description">
            <a href="<?php echo esc_url($link); ?>" class="cartsy-bromine-product-card-title">
                <?php woocommerce_template_loop_product_title(); ?>
            </a>
            <div class="cartsy-bromine-product-card-price">
                <span class="price">
