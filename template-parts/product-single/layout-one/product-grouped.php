...
$grouped_product = !empty($args) ? $args['grouped_product'] : [];
$grouped_products = !empty($args) ? $args['grouped_products'] : [];
$quantites_required = !empty($args) ? $args['quantites_required'] : false;
				...
				foreach ($grouped_product_columns as $column_id) {
					...
					switch ($column_id) {
						case 'quantity':
							...
							break;
						case 'thumbnail':
							$thumbUrl =  get_the_post_thumbnail_url($grouped_product_child->get_id(), 'woocommerce_thumbnail');
							$value = '<img src="' . esc_url($thumbUrl) . '" alt="' . $grouped_product_child->get_name() . '">';
							break;
						case 'label':
