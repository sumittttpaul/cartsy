...
?>
<div id="product-<?php the_ID(); ?>" <?php wc_product_class('layout-one', $product); ?>>
    <?php if ($showBreadCrumb === 'on') { ?>
    ...
    <div class="cartsy-single-product-summary">

        <?php get_template_part('template-parts/product-single/layout-one/product', 'gallery'); ?>
        ...
        <div class="summary entry-summary">
            ...
            <div class="cartsy-woo-divider"></div>
            ...
            <?php get_template_part('template-parts/product-single/layout-one/product', 'tabs'); ?>
        </div>
    </div>
