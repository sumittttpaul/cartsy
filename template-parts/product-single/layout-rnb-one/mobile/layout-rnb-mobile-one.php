...
?>
<div id="product-<?php the_ID(); ?>" <?php wc_product_class('rnb-layout-one mobile-layout', $product); ?>>
	...
	<div class="cartsy-single-product-summary cartsy-rnb-single-product-summary cartsy-rnb-single-product-mobile-summary">
		<div class="summary entry-summary">
			<div class="rnb-layout-one-header">
				...
				<!-- Price -->
				<?php get_template_part('template-parts/product-single/layout-rnb-one/mobile/rental-product-mobile', 'price'); ?>
			</div>

			<!-- RnB Price Flipbox -->
			<?php get_template_part('template-parts/product-single/layout-rnb-one/mobile/rental-product-mobile', 'flipbox'); ?>

			<!-- RnB Product Gallery -->

			<?php get_template_part('template-parts/product-single/layout-rnb-one/mobile/rental-product-mobile', 'gallery'); ?>


			<!-- RnB Attributes -->

			<?php get_template_part('template-parts/product-single/layout-rnb-one/mobile/rental-product-mobile', 'attributes'); ?>
			...
			<?php
			if ($showTabs === 'on') {
				get_template_part('template-parts/product-single/layout-rnb-one/mobile/rental-product-mobile', 'tabs');
			}
			?>
		</div>
	</div>
